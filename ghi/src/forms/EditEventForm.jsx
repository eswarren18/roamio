...
// The EditEventForm component handles the editing of event details
function EditEventForm({ activityId, tripData, onClose }) {
    ...
    const handleFormChange = ({ target }) => {
        ...
        setFormData((prevState) => {
            ...
            if (
                newFormData.start_date < tripStartDate ||
                newFormData.start_date > tripEndDate
            ) {
                newFormData.start_date = ''
            }
            if (
                newFormData.end_date < tripStartDate ||
                newFormData.end_date > tripEndDate
            ) {
        ...
        <>
            ...
            >
                ...
                <div className="flex items-center">
                    ...
                    >
                        <input
                            className="block py-2.5 px-0 w-full text-xs text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            id="start_date"
                            name="start_date"
                            onChange={handleFormChange}
                            placeholder=" "
